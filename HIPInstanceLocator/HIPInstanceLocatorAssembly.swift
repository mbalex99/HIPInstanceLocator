 ...
 */
struct HIPInstanceLocatorAssembly {
     ...
     */
    init(assemblyBlock: HIPInstanceLocator -> Void) {
        _assemblyBlock = assemblyBlock
    }
}

extension HIPInstanceLocator {
    /**
     ...
     */
    func assemble(assemblies: HIPInstanceLocatorAssembly...) {
